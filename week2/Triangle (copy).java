...
class Triangle {
    ...
    Type classify() {
      private int is_flat(int a0, int b0, int c0) {
         if (a0 == 0 || b0 == 0 || c0 == 0) {
            return Flat;
         }
      }
      private int is_equilateral(int a0, int b0, int c0) {
         if ((a0 == b0)&& (a0 == c0)) {
            return Equilateral;
         }
      private int is_isosceles(int a0, int b0, int c0) {
         if ((a0 == b0)||(a0==c0)||(b0==c0)) {
            return Isosceles;
         }
      }
      private int is_scalene(int a0, int b0, int c0) {
         if (a0 != b0 && a0 != c0) {
            return Scalene;
         }
      }
/*      private int is_right(int a0, int b0, int c0) {

      }
      private int is_impossible(int a0, int b0, int c0) {
